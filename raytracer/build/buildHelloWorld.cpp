...
void World::build(void)
{
  ...
  sphere_ptr->set_material(new Cosine(RGBColor(0, 1, 0)));
  ...
  triangle_ptr->set_material(new Cosine(RGBColor(1, 0, 0)));
  ...
  plane_ptr->set_material(new Cosine(RGBColor(0, 0, 1))); // green
